...
public:
  ...
  //crisp value
  inline double DeFuzzify(const std::string & key, DefuzzifyMethod method = max_av);
...
inline void FuzzyModule::Fuzzify(const std::string & NameOfFLV, double val)
{
  ...
  assert(
    (m_Variables.find(NameOfFLV) != m_Variables.end()) && "<FuzzyModule::Fuzzify>:key not found");
...
//  crisp value
//-----------------------------------------------------------------------------
inline double FuzzyModule::DeFuzzify(const std::string & NameOfFLV, DefuzzifyMethod method)
{
  //first make sure the key exists
  assert(
    (m_Variables.find(NameOfFLV) != m_Variables.end()) &&
