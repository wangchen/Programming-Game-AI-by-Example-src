...
Raven_Bot * Raven_Projectile::GetClosestIntersectingBot(Vector2D From, Vector2D To) const
{
...
std::list<Raven_Bot *> Raven_Projectile::GetListOfIntersectingBots(Vector2D From, Vector2D To) const
{
