...
:
  ...
  Raven_Projectile(
    ...
    script->GetInt("Slug_Damage"), script->GetDouble("Slug_Scale"),
    script->GetDouble("Slug_MaxSpeed"), script->GetDouble("Slug_Mass"),
...
void Slug::TestForImpact()
{
  ...
  for (it = hits.begin(); it != hits.end(); ++it) {
    ...
    Dispatcher->DispatchMsg(
      SEND_MSG_IMMEDIATELY, m_iShooterID, (*it)->ID(), Msg_TakeThatMF, (void *)&m_iDamageInflicted);
  }
}
